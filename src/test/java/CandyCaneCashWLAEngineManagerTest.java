...
public class CandyCaneCashWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(CandyCaneCashWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/CandyCaneCashWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/CandyCaneCashWLAIW/InitOutcome.xml").getDocumentElement();
